...
if __name__ == "__main__":
	...
	with open("npm_top_n.json", "w", encoding = "utf-8") as f:
		json.dump(pkg, f, indent = 2, ensure_ascii = False)
	with open("npm_all_responses.json", "w", encoding = "utf-8") as f:
		json.dump(responses, f, indent = 2, ensure_ascii = False)
	print("Complete...Saved",len(packages),"packages in npm_top_n.json")
